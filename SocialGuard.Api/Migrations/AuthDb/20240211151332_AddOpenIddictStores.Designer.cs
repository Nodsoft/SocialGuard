...
namespace SocialGuard.Api.Migrations.ApiDb
{
    ...
    [Migration("20240211151332_AddOpenIddictStores")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialGuard.Api.Data.Authentication.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SocialGuard.Api.Data.Authentication.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a2548a0e-7a8e-4bf9-9a2c-4f699d9b883f"),
                            Name = "admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("204015a3-6bea-431c-9d81-df63aa2323d9"),
                            Name = "emitter",
                            NormalizedName = "EMITTER"
                        });
                });

            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SocialGuard.Api.Data.Authentication.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("SocialGuard.Api.Data.Authentication.ApplicationUser", null)
                        .WithMany()
