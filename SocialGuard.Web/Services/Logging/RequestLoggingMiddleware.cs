...
namespace SocialGuard.Web.Services.Logging
{
	public class RequestLoggingMiddleware
	{
		private const string MessageTemplate = "HTTP {RequestMethod} {RequestPath} by {RemoteHost}, responded {StatusCode} in {Elapsed:0.0000} ms";
